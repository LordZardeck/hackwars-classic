...
public class NewFireWall {
    ...
    */
    ...
    public float modifyDamage(float damage, String ip, int port, boolean damageFromFireWall) {
        ...
        switch (portType) {
            case Port.BANKING:
                damageModifier = getBankDamageModifier();
                break;
            case Port.FTP:
                damageModifier = getFTPDamageModifier();
                break;
            case Port.ATTACK:
                damageModifier = getAttackDamageModifier();
                break;
            case Port.HTTP:
                damageModifier = getHTTPDamageModifier();
                break;
            case Port.REDIRECT:
                damageModifier = getRedirectDamageModifier();
                break;
        }
