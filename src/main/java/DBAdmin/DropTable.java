...
public class DropTable extends JFrame implements MouseListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent AE) {
        ...
        } else if (AE.getActionCommand().equals("Add_Item_To_Drop_Table")) {
        ...
        } else if (AE.getActionCommand().equals("Remove_Drop_Item")) {
        ...
        } else if (AE.getActionCommand().equals("Save_Item")) {
        ...
        } else if (AE.getActionCommand().equals("Save_Item_New")) {
        ...
        } else if (name.equals("Load_Current_Drop_Table")) {
