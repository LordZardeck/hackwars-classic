...
class RequestZombieAttackTest {
    ...
    fun fromRpc_and_toRfc_roundtrip() {
        ...
        val rpc = RemoteFunctionCall(1, com.hackwars.rpc.GameCommandWires.REQUESTZOMBIEATTACK, params)
        ...
        assertEquals(com.hackwars.rpc.GameCommandWires.REQUESTZOMBIEATTACK, serialized.function)
