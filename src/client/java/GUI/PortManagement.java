...
public class PortManagement extends Application implements ItemListener, FocusListener {
    ...
    public synchronized void addData() {
        ...
        for (int i = 0; i < ports.length; i++) {
            ...
            switch (type) {
                case PacketPort.BANKING:
                    this.type[port].setText("<html><u>" + Constants.applicationType[0] + "</u></html>");
                    break;
                case PacketPort.ATTACK:
                    this.type[port].setText("<html><u>" + Constants.applicationType[1] + "</u></html>");
                    break;
                case PacketPort.SHIPPING:
                    this.type[port].setText("<html><u>" + Constants.applicationType[2] + "</u></html>");
                    break;
                case PacketPort.FTP:
                    this.type[port].setText("<html><u>" + Constants.applicationType[3] + "</u></html>");
                    break;
                case PacketPort.HTTP:
                    this.type[port].setText("<html><u>" + Constants.applicationType[4] + "</u></html>");
                    break;
            }
