...
public class OpenGLRenderEngine extends RenderEngine implements KeyListener, MouseMotionListener, MouseListener {
    ...
    public void generateLists(GL gl, GLU glu, GLUT glut) {
        ...
        gl.glVertex3f(64.0f, 64.0f, 32.0f);    // Bottom Left Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(32.0f, 64.0f, 32.0f);    // Bottom Right Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(32.0f, 32.0f, 32.0f);    // Top Right Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(64.0f, 32.0f, 32.0f);    // Top Left Of The Texture and Quad
        // Bottom
        gl.glNormal3f(0.0f, 0.0f, 1.0f);
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(64.0f, 64.0f, 64.0f);    // Bottom Right Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(64.0f, 32.0f, 64.0f);    // Top Right Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(32.0f, 32.0f, 64.0f);    // Top Left Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 0.0f);
        gl.glVertex3f(32.0f, 64.0f, 64.0f);    // Bottom Left Of The Texture and Quad

        // Top Face
        gl.glNormal3f(0.0f, -1.0f, 0.0f);
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(64.0f, 32.0f, 64.0f);    // Top Left Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 0.0f);
        gl.glVertex3f(64.0f, 32.0f, 32.0f);    // Bottom Left Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(32.0f, 32.0f, 32.0f);    // Bottom Right Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(32.0f, 32.0f, 64.0f);    // Top Right Of The Texture and Quad
        // Bottom Face
        gl.glNormal3f(0.0f, 1.0f, 0.0f);
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(64.0f, 64.0f, 64.0f);    // Top Right Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(32.0f, 64.0f, 64.0f);    // Top Left Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 0.0f);
        gl.glVertex3f(32.0f, 64.0f, 32.0f);    // Bottom Left Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(64.0f, 64.0f, 32.0f);    // Bottom Right Of The Texture and Quad

        // Right face
        gl.glNormal3f(1.0f, 0.0f, 0.0f);
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(32.0f, 64.0f, 64.0f);    // Bottom Right Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(32.0f, 32.0f, 64.0f);    // Top Right Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(32.0f, 32.0f, 32.0f);    // Top Left Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 0.0f);
        gl.glVertex3f(32.0f, 64.0f, 32.0f);    // Bottom Left Of The Texture and Quad
        // Left Face
        gl.glNormal3f(-1.0f, 0.0f, 0.0f);
        gl.glTexCoord2f(0.0f, 0.0f);
        gl.glVertex3f(64.0f, 64.0f, 64.0f);    // Bottom Left Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(64.0f, 64.0f, 32.0f);    // Bottom Right Of The Texture and Quad
        gl.glTexCoord2f(1.0f, 1.0f);
        gl.glVertex3f(64.0f, 32.0f, 32.0f);    // Top Right Of The Texture and Quad
        gl.glTexCoord2f(0.0f, 1.0f);
        gl.glVertex3f(64.0f, 32.0f, 64.0f);    // Top Left Of The Texture and Quad
		...
		/*	if(MySpriteFace==null){//Intialize Sprite related stuff.
            ...
            if (obj.length > 0) {//Should we do any 2D rendering?
                ...
                for (int i = 0; i < obj.length; i++) {//Check for any world based drawing first.
                    ...
                    } else if (type == RECTANGLE_WORLD) {
                        drawRectangleWorld(gl, glut, O);
                    } else if (type == FILL_RECTANGLE_WORLD) {
