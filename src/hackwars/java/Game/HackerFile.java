...
public class HackerFile implements Serializable {
    ...
    public String[] getTypeKeys() {
        if (type == BANKING_COMPILED || type == BANKING_SCRIPT) {
            ...
            return (returnMe);
        } else if (type == ATTACKING_COMPILED || type == ATTACKING_SCRIPT || type == SHIPPING_COMPILED || type == SHIPPING_SCRIPT) {
            String returnMe[] = new String[]{"initialize", "finalize", "continue"};
            return (returnMe);
        } else if (type == WATCH_COMPILED || type == WATCH_SCRIPT) {
            String returnMe[] = new String[]{"fire"};
            return (returnMe);
        } else if (type == FTP_COMPILED || type == FTP_SCRIPT) {
